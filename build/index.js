  ...
  \**********************/
            /***/ (
                ...
                /* harmony import */ var _modules_Search__WEBPACK_IMPORTED_MODULE_3__ =
                    __webpack_require__(
                        /*! ./modules/Search */ "./src/modules/Search.js"
                    );
                ...
                const mobileMenu =
                    new _modules_MobileMenu__WEBPACK_IMPORTED_MODULE_1__[
                        "default"
                    ]();
                const heroSlider =
                    new _modules_HeroSlider__WEBPACK_IMPORTED_MODULE_2__[
                        "default"
                    ]();
                const fullPageSearch =
                    new _modules_Search__WEBPACK_IMPORTED_MODULE_3__[
                        "default"
                    ]();
  ...
  \***********************************/
            /***/ (
                ...
                class MobileMenu {
                    constructor() {
                        this.menu =
                            document.querySelector(".site-header__menu");
  ...
  \*******************************/
            /***/ (
                ...
                class Search {
                    ...
                    closeOverlay() {
                        this.searchOverlay.removeClass(
  ...
  \*******************************************************/
                    ...
                    _createClass(EventsBus, [
                        {
                            ...
                            value: function on(event, handler) {
                                ...
                                var index =
                                    this.events[event].push(handler) - 1; // Provide handle back for removal of event
                ...
                function Run(Glide, Components, Events) {
                    var Run = {
                        ...
                        make: function make(move) {
                            ...
                            if (!Glide.disabled) {
                                !Glide.settings.waitForTransition ||
                                    Glide.disable();
                                this.move = move;
                        ...
                        calculate: function calculate() {
                            ...
                            if (
                                ...
                                Glide.index = normalizeForwardIndex(
                                    index,
                                    viewSize
                                );
                                return;
                            ...
                            if (
                                ...
                                Glide.index = normalizeBackwardIndex(
                                    _index,
                                    viewSize
                                );
                                return;
                ...
                function Html(Glide, Components, Events) {
                    var Html = {
                        ...
                        mount: function mount() {
                            ...
                            this.track =
                                this.root.querySelector(TRACK_SELECTOR);
                            this.collectSlides();
                        },
                            ...
                            if (slides.length !== 0) {
                                ...
                                for (
                                    ...
                                    for (
                                        ...
                                        var _clone =
                                            prepend[_i].cloneNode(true);

                                        _clone.classList.add(
                                            classes.slide.clone
                                        );
                ...
                function Gap(Glide, Components) {
                    return {
                        ...
                        modify: function modify(translate) {
                            ...
                            return (
                                translate + Components.Gaps.value * multiplier
                            );
                        },
                    };
                }
                ...
                function Translate(Glide, Components, Events) {
                    var Translate = {
                        ...
                        set: function set(value) {
                            ...
                            Components.Html.wrapper.style.mozTransform =
                                translate3d; // needed for supported Firefox 10-15

                            Components.Html.wrapper.style.webkitTransform =
                                translate3d; // needed for supported Chrome 10-35, Safari 5.1-8, and Opera 15-22
                    ...
                    Events.on("move", function (context) {
                        ...
                        Components.Transition.after(function () {
                            ...
                            Translate.set(
                                Components.Sizes.slideWidth * Glide.index
                            );
                        });
                        var startWidth =
                            Components.Sizes.slideWidth *
                        ...
                        return Translate.set(
                            startWidth -
                                Components.Translate.getTravelDistance()
                        );
                    });
                    /**
                     * Remove translate:
                    ...
                    var Swipe = {
                        ...
                        bindSwipeStart: function bindSwipeStart() {
                            ...
                            var _Glide$settings3 = Glide.settings,
                                swipeThreshold =
                                    _Glide$settings3.swipeThreshold,
                ...
                function Lazy(Glide, Components, Events) {
                    ...
                    var Lazy = {
                        ...
                        lazyLoad: function lazyLoad() {
                            var length;
                            var additionSlides =
                                settings.lazyInitialSlidesLoaded - 1;
                            inView = true;

                            if (
                                Glide.index + additionSlides <
                            ...
                            for (var i = 0; i <= length; i++) {
                                var img =
                                    this._slideElements[i].getElementsByTagName(
                                        "img"
                                    )[0];

                                if (
                                    img &&
                                    img.classList.contains("glide__lazy")
                                ) {
                                    if (
                                        !this._slideElements[
                                            i
                ...
                function Anchors(Glide, Components, Events) {
                    ...
                    var Anchors = {
                        ...
                        mount: function mount() {
                             ...
                             */
                            this._a =
                                Components.Html.wrapper.querySelectorAll("a");
                            this.bind();
                        },
                ...
                function Controls(Glide, Components, Events) {
                    ...
                    var Controls = {
                        ...
                        removeClass: function removeClass(controls) {
                            ...
                            if (item) {
                                item.classList.remove(
                                    Glide.settings.classes.nav.active
                                );
                            }
                        },
                            ...
                            lists.forEach(function (list) {
                                toArray(list).forEach(function (element) {
                                    element.classList.remove(
                                        settings.classes.arrow.disabled
                                    );
                                });
                            });
                        },
                        ...
                        click: function click(event) {
                            ...
                            Components.Run.make(
                                Components.Direction.resolve(direction)
                            );
                        },
                    };
    ...
    /******/ (() => {
        ...
        /******/ var chunkLoadingGlobal = (globalThis[
            "webpackChunkedt_university"
        ] = globalThis["webpackChunkedt_university"] || []);
